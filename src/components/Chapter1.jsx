...
import EndOfChapterImage from './EndOfChapterImage'; // Assuming this component displays the end of chapter image
...
const Chapter1 = () => {
    return (
        <div>
            <h1>Chapter 1</h1>
            <p>
                Through it all, I held on to my belief that there was a greater plan at work, that even in the face of adversity, there was a purpose to be fulfilled. I drew strength from my faith, finding solace in the knowledge that I was not alone in this struggle.  
            ...
            <EndOfChapterImage imageUrl="/images/tree.jpg" /> Pass the image URL
            <p>
